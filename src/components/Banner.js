...
import { FaGithub, FaYoutube, FaTelegram, FaInstagram } from "react-icons/fa"
    ...
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x12'>
        ...
        <div className='flex-1 text-center font-secondery lg:text-left'>
          ...
          < motion.p variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='mb-8 max-w-lg mx-auto lg:mx-0'>I'm a Web Developer with extensive experience for over 1 year.
            Expertise is to create website developer, Frontend, and many more ... </motion.p>
          ...
          < motion.div variants={fadeIn('up', 0.7)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
            <a href="https://github.com/baxtiyor0005">
              <FaGithub />
            </a>
            <a href="https://www.youtube.com/@shaxxxpubgm-2005">
              <FaYoutube />
            </a>
            <a href="https://t.me/shaxxx_xxl">
             <FaTelegram/>
            </a>
            <a href="https://www.instagram.com/bekchanov.me/">
              <FaInstagram/>
            </a>
        ...
        < motion.div variants={fadeIn('down')} initial='hidden' whileInView={'show'} className='hidden lg:flex flex-1 max-w-[320px] lg:max-w-[482px]'>
          <img className=' box-shadow:#0ef border rounded-[50%]' src={Image} alt="" />
        </motion.div>
      </div>
    </div>;
  </section>
