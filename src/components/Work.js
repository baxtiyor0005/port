...
import Img1 from '../assets/po1.jpg'
import Img2 from '../assets/po2.jpg'
import Img3 from '../assets/po3.jpg'
      ...
      <div className='flex flex-col lg:flex-row  gap-x-10'>
        ...
        < motion.div variants={fadeIn('right', 0.3)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='flex-1 flex flex-col gap-y-[70px] mb-10 lg:mb-0'>
          ...
          <div>
            ...
            <p className='max-w-sm mb-16'>I'm a Freelance Front-end Developer with over 2 years of experience</p>
